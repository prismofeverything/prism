...
fn main() {
    ...
    for tick in 0..200 {
        ...
        eprintln!("tick={} t={:.1} n={} mass={:.4} wall={:.1}s", tick, engine.time(), n, total, elapsed);
    }
}
